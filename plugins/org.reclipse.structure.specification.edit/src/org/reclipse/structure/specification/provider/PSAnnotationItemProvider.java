...
import org.reclipse.structure.specification.descriptor.PSAnnotationTypePropertyDescriptor;


/**
 * This is the item provider adapter for a {@link org.reclipse.structure.specification.PSAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PSAnnotationItemProvider
      ...
      IItemPropertySource
{
    ...
    * @generated
    */
   public PSAnnotationItemProvider(AdapterFactory adapterFactory)
   {
   ...
   {
      itemPropertyDescriptors.add
         (new PSAnnotationTypePropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PSAnnotation_type_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_PSAnnotation_type_feature", "_UI_PSAnnotation_type"),
             SpecificationPackage.Literals.PS_ANNOTATION__TYPE,
             true,
             false,
             true,
             null,
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/PSAnnotation"));
   }
   ...
   {
      String label = ((PSAnnotation)object).getName();
      return label == null || label.length() == 0 ?
         getString("_UI_PSAnnotation_type") :
         getString("_UI_PSAnnotation_type") + " " + label;
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(PSAnnotation.class))
      {
