...
/**
 * This is the item provider adapter for a {@link org.reclipse.structure.specification.PSFuzzyMetricConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PSFuzzyMetricConstraintItemProvider
      ...
      IItemPropertySource
{
    ...
    * @generated
    */
   public PSFuzzyMetricConstraintItemProvider(AdapterFactory adapterFactory)
   {
   ...
   protected void addMetricAcronymPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (new PSMetricConstraintAcronymPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PSFuzzyMetricConstraint_metricAcronym_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_PSFuzzyMetricConstraint_metricAcronym_feature", "_UI_PSFuzzyMetricConstraint_type"),
             SpecificationPackage.Literals.PS_FUZZY_METRIC_CONSTRAINT__METRIC_ACRONYM,
             true,
             false,
             false,
             ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
   ...
   /**
    * This returns PSFuzzyMetricConstraint.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/PSFuzzyMetricConstraint"));
   }
   ...
   {
      String label = ((PSFuzzyMetricConstraint)object).getMetricAcronym();
      return label == null || label.length() == 0 ?
         getString("_UI_PSFuzzyMetricConstraint_type") :
         getString("_UI_PSFuzzyMetricConstraint_type") + " " + label;
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(PSFuzzyMetricConstraint.class))
      {
