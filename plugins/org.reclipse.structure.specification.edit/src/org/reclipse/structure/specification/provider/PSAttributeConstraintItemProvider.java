...
import org.reclipse.structure.specification.descriptor.PSAttributeConstraintAttributePropertyDescriptor;


/**
 * This is the item provider adapter for a {@link org.reclipse.structure.specification.PSAttributeConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PSAttributeConstraintItemProvider
      ...
      IItemPropertySource
{
    ...
    * @generated
    */
   public PSAttributeConstraintItemProvider(AdapterFactory adapterFactory)
   {
   ...
   {
      itemPropertyDescriptors.add
            (new PSAttributeConstraintAttributePropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PSAttributeConstraint_attribute_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_PSAttributeConstraint_attribute_feature", "_UI_PSAttributeConstraint_type"),
   ...
   /**
    * This returns PSAttributeConstraint.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/PSAttributeConstraint"));
   }
   ...
   {
      String label = ((PSAttributeConstraint)object).getName();
      return label == null || label.length() == 0 ?
         getString("_UI_PSAttributeConstraint_type") :
         getString("_UI_PSAttributeConstraint_type") + " " + label;
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(PSAttributeConstraint.class))
      {
