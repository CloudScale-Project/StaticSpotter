 ...
 */
public class VMSystemOutPoller extends AbstractVMStreamPoller
{

   public VMSystemOutPoller(InputStream inStream)
   {
      super(inStream);
      setName("Target VM's System.out poller");
   }
   ...
   {
      return Tracer.iteratorOfSystemOutReceivers();
   }
