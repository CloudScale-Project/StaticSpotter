...
public class MethodReferencePropertyDescriptor extends ItemPropertyDescriptor
{


   public MethodReferencePropertyDescriptor(AdapterFactory adapterFactory, ResourceLocator resourceLocator,
   ...
   public Collection<?> getChoiceOfValues(Object object)
   {
      ...
      for (Object o : availablePSObjects)
      {
         if (o != null)
         {
            ...
            if (ASTUtil.objectIsMethod(psObject) && objectIsInRightPattern(object, psObject))
            {
   ...
   {
      if (object instanceof BPMessage)
      {
         BPMessage bpMessage = (BPMessage) object;
         String behavioralPatternName = bpMessage.getDiagram().getName();
