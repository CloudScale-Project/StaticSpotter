...
/**
 * This metric calculates the nested block depth (NBLD) for different elements. Supported elements
 * are elements or sub types of the following:
 * 
 * <dl>
 * <dt>{@link Root Project}</dt>
 * <dd>The average NBLD of all packages inside the project.</dd>
 * <dt>{@link Package Package}</dt>
 * <dd>The average NBLD of all classes inside the package.</dd>
 * <dt>{@link GASTClass Class}</dt>
 * <dd>The average NBLD of all methods inside the class.</dd>
 * <dt>{@link Function Method}</dt>
 * <dd>The NBLD of the method.</dd>
 * </dl>
 * 
 ...
 * @author harka
 */
public class NBLDCalculator extends AbstractGASTMetricCalculator
{
   ...
   public double calculate(EObject object)
   {
      if (object != null)
      {
         ...
         {
            // FIXME: calculate NBLD for the method or constructor
         }
      }
