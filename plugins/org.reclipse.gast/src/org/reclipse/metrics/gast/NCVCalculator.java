...
/**
 * This metric calculates the number of class variables (NCV) for different elements. Supported
 * elements are elements or sub types of the following:
 * 
 * <dl>
 * <dt>{@link Root Project}</dt>
 * <dd>The average NCV of all packages inside the project.</dd>
 * <dt>{@link Package Package}</dt>
 * <dd>The average NCV of all classes inside the package.</dd>
 * <dt>{@link GASTClass Class}</dt>
 * <dd>The NCV inside the class.</dd>
 * </dl>
 * 
 ...
 * @author harka
 */
public class NCVCalculator extends AbstractGASTMetricCalculator
{

   private boolean ignoreInnerClasses;


   public NCVCalculator()
   {
      super();
