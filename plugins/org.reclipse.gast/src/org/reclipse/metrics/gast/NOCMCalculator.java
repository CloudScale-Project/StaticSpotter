...
/**
 * This metric calculates the number of constructor methods (NOCM) for different elements. Supported
 * elements are elements or sub types of the following:
 * 
 * <dl>
 * <dt>{@link Root Project}</dt>
 * <dd>The total NOCM of all packages inside the project.</dd>
 * <dt>{@link Package Package}</dt>
 * <dd>The total NOCM of all classes inside the package.</dd>
 * <dt>{@link GASTClass Class}</dt>
 * <dd>The NOCM inside the class.</dd>
 * </dl>
 * 
 ...
 * @author harka
 */
public class NOCMCalculator extends
      AbstractGASTMetricCalculator
{
   ...
   public double calculate(EObject object)
   {
      if (object != null)
      {
         ...
         {
            return ((GASTClass) object).getConstructors().size();
         }
      }
