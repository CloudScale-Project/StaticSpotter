...
/**
 * This metric calculates the number of methods extended (NME) for different elements. Supported
 * elements are elements or sub types of the following:
 * 
 * <dl>
 * <dt>{@link Root Project}</dt>
 * <dd>The total NME of all packages inside the project.</dd>
 * <dt>{@link Package Package}</dt>
 * <dd>The total NME of all classes inside the package.</dd>
 * <dt>{@link GASTClass Class}</dt>
 * <dd>The NME inside the class.</dd>
 * </dl>
 * 
 ...
 * @author harka
 */
public class NMECalculator extends
