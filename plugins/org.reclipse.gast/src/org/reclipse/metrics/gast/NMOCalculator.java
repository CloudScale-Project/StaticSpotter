...
/**
 * This metric calculates the number of methods overridden (NMO) for different elements. Supported
 * elements are elements or sub types of the following:
 * 
 * <dl>
 * <dt>{@link Root Project}</dt>
 * <dd>The total NMO of all packages inside the project.</dd>
 * <dt>{@link Package Package}</dt>
 * <dd>The total NMO of all classes inside the package.</dd>
 * <dt>{@link GASTClass Class}</dt>
 * <dd>The NMO inside the class.</dd>
 * </dl>
 * 
 ...
 * @author harka
 */
public class NMOCalculator extends AbstractGASTMetricCalculator
{

   private boolean ignoreInnerClasses;


   public NMOCalculator()
   {
      super();
