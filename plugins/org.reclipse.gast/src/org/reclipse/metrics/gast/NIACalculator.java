...
/**
 * This metric calculates the number of inherited attributes (NIA) for different elements. Supported
 * elements are elements or sub types of the following:
 * 
 * <dl>
 * <dt>{@link Root Project}</dt>
 * <dd>The average NIA of all packages inside the project.</dd>
 * <dt>{@link Package Package}</dt>
 * <dd>The average NIA of all classes inside the package.</dd>
 * <dt>{@link GASTClass Class}</dt>
 * <dd>The NIA inside the class.</dd>
 * </dl>
 * 
 ...
 * @author harka
 */
public class NIACalculator extends
