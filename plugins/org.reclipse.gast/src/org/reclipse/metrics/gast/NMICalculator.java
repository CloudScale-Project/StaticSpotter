...
/**
 * This metric calculates the number of methods inherited (NMI) for different elements. Supported
 * elements are elements or sub types of the following:
 * 
 * <dl>
 * <dt>{@link Root Project}</dt>
 * <dd>The total NMI of all packages inside the project.</dd>
 * <dt>{@link Package Package}</dt>
 * <dd>The total NMI of all classes inside the package.</dd>
 * <dt>{@link GASTClass Class}</dt>
 * <dd>The NMI inside the class.</dd>
 * </dl>
 * 
 ...
 * @author harka
 */
public class NMICalculator extends
