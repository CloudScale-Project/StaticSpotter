...
/**
 * This metric calculates the number of methods (NOM) for different elements. Supported elements are
 * elements or sub types of the following:
 * 
 * <dl>
 * <dt>{@link Root Project}</dt>
 * <dd>The total NOM of all packages inside the project.</dd>
 * <dt>{@link Package Package}</dt>
 * <dd>The total NOM of all classes inside the package.</dd>
 * <dt>{@link GASTClass Class}</dt>
 * <dd>The NOM inside the class.</dd>
 * </dl>
 * 
 ...
 * @author harka
 */
public class NOMCalculator extends AbstractGASTMetricCalculator
{

   private boolean ignoreInnerClasses;


   public NOMCalculator()
   {
      super();
   ...
   public double calculate(EObject object)
   {
      if (object != null)
      {
         ...
         {
            return ((GASTClass) object).getMethods().size();
         }
      }
