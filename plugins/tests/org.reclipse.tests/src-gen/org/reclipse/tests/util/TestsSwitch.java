...
public class TestsSwitch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case TestsPackage.TYPE_A:
			{
				TypeA typeA = (TypeA)theEObject;
				T result = caseTypeA(typeA);
				if (result == null) result = caseNamed(typeA);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestsPackage.TYPE_B:
			{
				TypeB typeB = (TypeB)theEObject;
				T result = caseTypeB(typeB);
				if (result == null) result = caseNamed(typeB);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TestsPackage.ROOT:
			{
				Root root = (Root)theEObject;
				T result = caseRoot(root);
				if (result == null) result = caseNamed(root);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
