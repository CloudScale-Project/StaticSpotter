 ...
 * $Id$
 */
package org.reclipse.tests.util;
...
public class TestsAdapterFactory extends AdapterFactoryImpl
{
	...
	protected TestsSwitch<Adapter> modelSwitch =
		...
		{
			@Override
			public Adapter caseTypeA(TypeA object)
			{
				return createTypeAAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.reclipse.tests.TypeA <em>Type A</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTypeAAdapter()
	{
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.reclipse.tests.TypeB <em>Type B</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.reclipse.tests.Named <em>Named</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.reclipse.tests.Root <em>Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
