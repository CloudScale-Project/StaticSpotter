...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>BP Set Object</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.reclipse.behavior.specification.impl.BPSetObjectImpl#getTypeReference <em>Type Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BPSetObjectImpl extends AbstractSequenceDiagramObjectImpl implements BPSetObject
{
   /**
   ...
   {
      return BehavioralpatternPackage.Literals.BP_SET_OBJECT;
   }
      ...
      if (typeReference != null && typeReference.eIsProxy())
      {
         ...
         if (typeReference != oldTypeReference)
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, BehavioralpatternPackage.BP_SET_OBJECT__TYPE_REFERENCE, oldTypeReference, typeReference));
         }
      }
   ...
   public void setTypeReference(PSObject newTypeReference)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, BehavioralpatternPackage.BP_SET_OBJECT__TYPE_REFERENCE, oldTypeReference, typeReference));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType)
   {
      switch (featureID)
      {
         case BehavioralpatternPackage.BP_SET_OBJECT__TYPE_REFERENCE:
